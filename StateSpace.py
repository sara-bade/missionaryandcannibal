...
rec1 = pygame.image.load(os.path.join('shapes/rec1.png')).convert()
rec2 = pygame.image.load(os.path.join('shapes/rec2.png')).convert()
rec3 = pygame.image.load(os.path.join('shapes/rec3.png')).convert()
rec4 = pygame.image.load(os.path.join('shapes/rec4.png')).convert()
while not done:
    clock.tick(10) 
    ...
    def state_tree(space,xpass,ypass):
        ...
        for i in range(5):
            ...
            if space.pos==0:
                ...
                space1.m=space.m+m1
            space1.parent=space
            data="["+str(space1.c)+","+str(space1.m)+","+str(space1.pos)+"] ("+str(c1)+","+str(m1)+")"
